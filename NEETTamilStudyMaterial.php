			...
			<div class="row  justify-content-md-center">
				<div class="col-xs-12 col-md-8">
					...
					<div id="demo" class="collapse">
						<?php
							echo "
								<iframe src='https://drive.google.com/embeddedfolderview?id=1hH1tKP1TCZiQb3EADfTPifBdfwNfkAie#list' width='100%' height='500' frameborder='0' class='responsive-iframe'></iframe>
							";
						?>
					</div> 
					...
					<div id="demo1" class="collapse">
						<?php
							echo "
								<iframe src='https://drive.google.com/embeddedfolderview?id=1jtu-VV5_fm7Ekt6wHXDWNib0uuSG-ED7#list' width='100%' height='500' frameborder='0' class='responsive-iframe'></iframe>
							";
						?>
					</div> 
					...
					<div id="demo3" class="collapse">
						<?php
							echo "
								<iframe src='https://drive.google.com/embeddedfolderview?id=1CqU1QFIfs1HdbVDf4SvNc-Yi6w0mgr11#list' width='100%' height='500' frameborder='0' class='responsive-iframe'></iframe>
							";
						?>
					</div> 
